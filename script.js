...
headerTitle.addEventListener('click', function() {
    const messages = [
        'вы официально первый',
        'вы официально второй',
        'вы официально третий'
    ];
...
const productDetails = [
    ["пин с гоблином для клешки"],
    ["скин на авп только для русских"],
    ["скин на маску в пей дай2"],
    ["геймпад розовый для истиных мужин"],
    ["сноуборд для фрирайда Arbor Terrapin 18/19"]
];
